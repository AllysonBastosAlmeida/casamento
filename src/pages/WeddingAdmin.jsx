...
export default function WeddingAdmin() {
  ...
  const releaseGift = async gift => {
    if (!window.confirm(`Liberar “${gift.giftName}” para que possa ser escolhido novamente?`)) return;
